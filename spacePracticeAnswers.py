...
b = a * 3
if b / a == 3:
	print(a, b, b / a) #or b/a would also be okay here as it could make the grouping clearer
...
suspects.sort(reverse = True) #reverse=True is also acceptable, 
                              #as this is a parameter assignment and can be excepted
                              #from the rule because of its low importance in the scheme
                              #of the function, but we didn't talk about this
print(suspects)
